...
.dash-card { background:#fff; border:1px solid #ddd; border-radius:18px; min-height:150px; padding:24px 28px; }
...
.recent-box { background:#fff; border:1px solid #ddd; border-radius:18px; padding:22px 28px; }
