...
.cat-btn{display:inline-flex;align-items:center;gap:10px;padding:11px 16px;border-radius:12px;background:#111827;color:#fff;text-decoration:none;font-weight:700}
...
.product-title{display:flex;align-items:center;gap:10px;flex-wrap:wrap}
.product-desc{font-size:13px;color:#6b7280;max-width:300px;display:-webkit-box;-webkit-line-clamp:2;-webkit-box-orient:vertical;overflow:hidden}
