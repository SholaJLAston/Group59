...
<div class="form-wrap">
    ...
    <form class="form-card" method="POST" action="{{ route('admin.categories.update', $category) }}" enctype="multipart/form-data">
        @csrf
        @method('PATCH')
        ...
        <div class="form-grid">
            ...
            <div class="form-group">
                <label class="form-label" for="image_file">Replace Image (optional)</label>
            ...
            <div class="form-group full">
                ...
                <img id="previewImage" class="preview" src="{{ $previewImage }}" alt="Preview" onerror="this.onerror=null;this.src='{{ asset('images/logo.png') }}';">
            </div>
        </div>

        <div class="actions">
            <a href="{{ route('admin.categories.index') }}" class="btn btn-cancel">Cancel</a>
            <button type="submit" class="btn btn-save"><i class="fa-solid fa-floppy-disk"></i> Update Category</button>
        </div>
    </form>
</div>
